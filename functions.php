...
function losmagos_register_styles(){
    ...
    wp_enqueue_style('tablet-stylesheet', get_template_directory_uri(). "/assets/css/tablet-style.css", array(),  $version ,'all');
...
function losmagos_register_scripts(){
    ...
    wp_enqueue_script("slick_sliders", get_theme_file_uri("/assets/js/slicksliders.js"), array('slick_js'), '1.0', true);
    wp_enqueue_script("header_menu", get_theme_file_uri("/assets/js/header.js"), array('jquery-js'), '1.0', true);
    wp_enqueue_script("shop_slide", get_theme_file_uri("/assets/js/shopslid.js"), array('jquery-js'), '1.0', true);
    ...
    // wp_enqueue_script('button-script', get_template_directory_uri().'/assets/js/buttoform.js',array(),'1.0', true);
